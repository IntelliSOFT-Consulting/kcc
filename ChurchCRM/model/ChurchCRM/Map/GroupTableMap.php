...
class GroupTableMap extends TableMap
{
    ...
    {
        $this->addRelation('ListOption', '\\ChurchCRM\\ListOption', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':grp_RoleListID',
    1 => ':lst_ID',
  ...
  array (
    ...
    1 => ':grp_ID',
        ...
        $this->addRelation('EventType', '\\ChurchCRM\\EventType', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':type_grpid',
    1 => ':grp_ID',
        ...
        $this->addRelation('EventAudience', '\\ChurchCRM\\EventAudience', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':group_id',
    1 => ':grp_ID',
