        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="box">
                    ...
                    <a class="btn btn-app"
                        href="<?= SystemURLs::getRootPath()?>/CanvassEditor.php?FamilyID=<?= $family->getId() ?>&amp;FYID=<?= $_SESSION['idefaultFY'] ?>&amp;linkBack=v2/family/<?= $family->getId() ?>">
                        <i
                    ...
                    <div class="box-body">
                        <ul class="fa-ul">
                            ...
                            <li><i class="fa-li fa fa-magic"></i><?= gettext("Wedding Date") ?>:
                                <span><?= $family->getWeddingDate()->format(SystemConfig::getValue("sDateFormatLong")) ?></span>
                            </li>
                            <?php
                            }
                    ...
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <input type="checkbox" id="ShowPledges"
                                <?= AuthenticationManager::GetCurrentUser()->getShowPledges() ? "checked" : "" ?>>
                            <?= gettext("Show Pledges") ?>
                            <input type="checkbox" id="ShowPayments"
                                <?= AuthenticationManager::GetCurrentUser()->getShowPayments() ? "checked" : "" ?>>
                            <?= gettext("Show Payments") ?>
                            <label for="ShowSinceDate"><?= gettext("Since") ?>:</label>
                            <input type="text" class="date-picker" id="ShowSinceDate"
                                value="<?= AuthenticationManager::GetCurrentUser()->getFormattedShowSince() ?>"
                                maxlength="10" id="ShowSinceDate" size="15">
                        </div>
                    </div>
                    <div class="box-body">
